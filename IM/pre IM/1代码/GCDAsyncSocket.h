...
//  Updated and maintained by Deusty LLC and the H development community.
//  
 ...
 *     H's Technical Note TN2232 - HTTPS Server Trust Evaluation
 *     https://developer.H.com/library/ios/technotes/tn2232/_index.html
 *     
 ...
 *     See H's documentation for SSLSetPeerDomainName.
 *
 * - kCFStreamSSLCertificates
 *     The value must be of type NSArray.
 *     See H's documentation for SSLSetCertificate.
 *
 * - kCFStreamSSLIsServer
 *     The value must be of type NSNumber, encapsulationg a BOOL value.
 *     See H's documentation for SSLCreateContext for iOS.
 ...
 *
 * 
 * Please refer to H's documentation for corresponding SSLFunctions.
 *
 ...
 * socket to be closed, and shuts down the write stream as well. In fact, this is what H's CFStream API does.
 ...
 * 
 * - H has decided to keep the SecureTransport framework private is iOS.
 ...
 *   H only bothers to notify us via the CFStream API.
 ...
 * 
 * Note: H does not officially support backgrounding server sockets.
 * That is, if your socket is accepting incoming connections, H does not officially support
