...
@protocol NewPSimplePingDelegate;
...
@interface NewPSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<NewPSimplePingDelegate> delegate;
...
@protocol NewPSimplePingDelegate <NSObject>
