...
- (void)handleInterruptionChangeToStateAvSesion:(AudioQueuePropertyID)inInterruptionState;
#endif
...
- (void)presentAlertWithTitle:(NSString*)title message:(NSString*)message
{
	...
	[NSNotification notificationWithName:ASPresentAlertWithTitleNotification object:self userInfo:userInfo];
